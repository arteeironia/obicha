...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#0f1a2e' }}>
      <aside className="w-64 flex flex-col border-r" style={{ borderColor: 'rgba(212,168,67,.2)', background: 'var(--navy)' }}>
        <div className="p-6 border-b" style={{ borderColor: 'rgba(212,168,67,.2)' }}>
