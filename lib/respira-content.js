...
// Medalhas por dias — trilha acumulativa, começa na decisão de parar
export const BADGE_LEVELS = [
  { days: 0, label: "Decisão tomada", icon: "🌱" },
  { days: 1, label: "1º dia", icon: "🔥" },
  { days: 3, label: "3 dias", icon: "💧" },
  { days: 7, label: "1 semana", icon: "🌤️" },
  { days: 15, label: "15 dias", icon: "🌿" },
...
// Afirmações de autoestima — ligadas ao tempo parado, desbloqueiam progressivamente e rotacionam por dia
export const ESTEEM_AFFIRMATIONS = [
  { minDays: 0, text: "Cada dia sem fumar já é um dia que seu corpo agradece — mesmo sem provas ainda." },
  { minDays: 0, text: "Você está construindo uma versão de você que não depende do cigarro pra existir." },
  { minDays: 0, text: "Parar de fumar é um ato de amor-próprio — e isso aparece, mesmo que ninguém saiba o motivo." },
  { minDays: 2, text: "Seu hálito já deve estar diferente do que era há poucos dias." },
  { minDays: 2, text: "Aquele boy do Grindr também pode preferir alguém que não fuma — e você tá cada dia mais perto disso." },
  { minDays: 3, text: "Sua roupa provavelmente já não pega tanto cheiro de cigarro." },
  { minDays: 5, text: "Menos cheiro de cigarro é mais chance daquele crush chegar perto sem hesitar." },
  { minDays: 7, text: "Seu paladar e olfato estão voltando — repara se a comida está com gosto diferente." },
  { minDays: 7, text: "Talvez você já não precise exagerar tanto no perfume." },
  { minDays: 10, text: "Beijar sem o gosto de cigarro muda a vibe de qualquer date." },
  { minDays: 14, text: "Seu fôlego pode estar melhor do que há duas semanas — repara na próxima escada." },
  { minDays: 14, text: "Autoestima também é sobre se sentir à vontade no seu próprio corpo, sem se esconder atrás de um cigarro." },
  { minDays: 21, text: "Seu sorriso pode estar começando a ganhar um aspecto diferente." },
  { minDays: 21, text: "Chegar perto de alguém sem se preocupar com o cheiro já é uma vitória de autoestima." },
  { minDays: 30, text: "Sua pele pode estar com uma aparência mais descansada." },
  { minDays: 30, text: "Quem chega perto de você pode estar percebendo a diferença, mesmo sem saber o motivo." },
  { minDays: 45, text: "Você não precisa de cigarro pra ter presença. Sua presença já é sua." },
  { minDays: 60, text: "Seu corpo já reorganizou boa parte do que a nicotina bagunçava." },
  { minDays: 90, text: "Você já é, fisicamente, uma pessoa bem diferente de quem começou essa jornada." },
];

export function getEsteemAffirmation(dayNumber) {
  const unlocked = ESTEEM_AFFIRMATIONS.filter((a) => dayNumber >= a.minDays);
  if (unlocked.length === 0) return ESTEEM_AFFIRMATIONS[0].text;
  return unlocked[dayNumber % unlocked.length].text;
}

export const HEALTH_MILESTONES = [
  { mins: 20, label: "20 minutos", icon: "❤️", fact: "Sua pressão começa a melhorar." },
  { mins: 12 * 60, label: "12 horas", icon: "🩸", fact: "O monóxido de carbono no seu sangue volta ao normal." },
  { mins: 24 * 60, label: "24 horas", icon: "💓", fact: "Seu risco de infarto já começa a cair." },
  { mins: 48 * 60, label: "48 horas", icon: "👅", fact: "Você sente melhor o gosto da comida." },
  { mins: 72 * 60, label: "72 horas", icon: "🌬️", fact: "A nicotina já saiu do seu corpo — respirar fica mais fácil." },
  { mins: 7 * 24 * 60, label: "7 dias", icon: "👕", fact: "Suas roupas já ficam menos impregnadas de cheiro." },
  { mins: 14 * 24 * 60, label: "14 dias", icon: "🫁", fact: "Sua circulação melhora e sua função pulmonar já está aumentando." },
  { mins: 15 * 24 * 60, label: "15 dias", icon: "🏃", fact: "Talvez você já consiga caminhar mais sem cansar." },
  { mins: 21 * 24 * 60, label: "21 dias", icon: "🧠", fact: "Três semanas — tempo médio que o cérebro leva pra começar a soltar um hábito." },
  { mins: 30 * 24 * 60, label: "30 dias", icon: "💋", fact: "Seu beijo agradece." },
  { mins: 60 * 24 * 60, label: "60 dias", icon: "🌬️", fact: "Seus pulmões continuam se limpando — tosse e falta de ar diminuem." },
  { mins: 90 * 24 * 60, label: "90 dias", icon: "✨", fact: "Sua pele pode parecer mais bonita." },
  { mins: 180 * 24 * 60, label: "6 meses", icon: "🌤️", fact: "Tosse, falta de ar e cansaço já caíram bastante." },
...
export const SOS_TECHNIQUES = [
  ...
  { id: "bolha-pop", title: "Bolha de plástico", icon: "🫧" },
  { id: "tetris", title: "Tetris", icon: "🧱" },
  { id: "memoria", title: "Jogo da memória", icon: "🎴" },
];

export const REWARD_THRESHOLDS = [
  { amount: 80, label: "Que tal um almoço legal?" },
  { amount: 200, label: "Um perfume novo?" },
  { amount: 500, label: "Um mimo pra você — quem sabe uma roupa nova" },
  { amount: 1500, label: "Uma viagem?" },
];

export const LEARN_CARDS = [
  { title: "Por que adiar o primeiro cigarro do dia ajuda?", text: "O primeiro cigarro da manhã costuma ser o mais viciante — ele reativa a dependência pelo resto do dia. Mesmo antes de parar de vez, tentar atrasar esse primeiro cigarro em 15, depois 30, depois 60 minutos já reduz a dependência física e prepara o corpo pra parada completa. É um bom primeiro passo pra quem ainda não se sente pronto pra parar de uma vez." },
  ...
  { title: "Quais nutrientes o cigarro rouba?", text: "Cada maço fumado pode custar até 500mg de vitamina C — a mesma que cuida da sua imunidade e cicatrização. O cigarro também reduz magnésio (que ajuda a segurar a ansiedade), zinco (paladar, olfato e pele), cálcio (ossos e dentes) e selênio (o antioxidante que retarda o envelhecimento). Boas fontes: frutas cítricas, castanhas, grãos integrais, carnes, ovos e vegetais coloridos." },
  { title: "Vou engordar ao parar de fumar?", text: "É comum, sim — em média homens ganham cerca de 3kg e mulheres cerca de 4kg nos primeiros meses, porque o apetite volta ao normal e o paladar melhora. Não é regra, e dá pra segurar isso com pequenas escolhas: comer em horários regulares, ter fruta ou castanha sempre por perto, preferir água a refrigerante, e não trocar o cigarro por beliscar o dia inteiro. O ganho, quando acontece, costuma ser tranquilo de reverter depois." },
];

// Kit Fissura — sugestões concretas de "algo pra boca" nos momentos de vontade
export const FISSURE_KIT_ITEMS = [
  { key: "secas", label: "Frutas secas", icon: "🍇", examples: "uva-passa, damasco, maçã desidratada" },
  { key: "oleaginosas", label: "Oleaginosas", icon: "🥜", examples: "castanha-do-pará, amêndoas, amendoim torrado" },
  { key: "sementes", label: "Sementes", icon: "🌻", examples: "girassol, abóbora" },
  { key: "especiarias", label: "Especiarias", icon: "🌿", examples: "canela em pau, cravo, gengibre" },
  { key: "legumes", label: "Petiscos de legumes", icon: "🥕", examples: "cenoura, pepino, tomate-cereja" },
  { key: "chips", label: "Chips caseiros assados", icon: "🍠", examples: "batata-doce, cenoura ou abobrinha fatiadas" },
];

// Diário do Cigarro — onde estava / com quem, usado no registro de recaída
export const COMPANY_OPTIONS = [
  { key: "sozinho", label: "Sozinho", icon: "🧍" },
  { key: "amigos", label: "Com amigos", icon: "👥" },
  { key: "casa", label: "Em casa", icon: "🏠" },
  { key: "trabalho", label: "No trabalho", icon: "💼" },
  { key: "bar_balada", label: "Bar ou balada", icon: "🍻" },
  { key: "rua", label: "Na rua", icon: "🚶" },
];

// Diário do Cigarro — como estava se sentindo antes de fumar
export const EMOTION_BEFORE_OPTIONS = [
  { key: "ansiedade", label: "Ansiedade", icon: "😰" },
  { key: "estresse", label: "Estresse", icon: "😤" },
  { key: "tristeza", label: "Tristeza", icon: "😔" },
  { key: "tedio", label: "Tédio", icon: "😑" },
  { key: "irritacao", label: "Irritação", icon: "😠" },
  { key: "alegria", label: "Alegria", icon: "😄" },
  { key: "relaxado", label: "Relaxado", icon: "😌" },
];
